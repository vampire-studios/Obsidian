...
public class BlockContentRegistries {
	...
	/**
	 * A {@link RegistryEntryAttachment} for tillable blocks.
	 * <p>
	 * Values can be set via code and through a datapack with the file {@code data/quilt_block_content_registry/attachments/minecraft/block/tillable_block.json}
	 */
	public static final RegistryEntryAttachment<Block, BlockState> TILLABLE = RegistryEntryAttachment
			.builder(Registry.BLOCK,
					new Identifier(NAMESPACE, "tillable"),
					BlockState.class,
					BlockState.CODEC)
			.build();
}