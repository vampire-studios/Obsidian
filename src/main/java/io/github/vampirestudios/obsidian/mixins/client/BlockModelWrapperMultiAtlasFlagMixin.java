...
import io.github.vampirestudios.obsidian.MultiAtlasMarked;
import net.minecraft.client.renderer.item.BlockModelWrapper;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Unique;

@Mixin(BlockModelWrapper.class)
public abstract class BlockModelWrapperMultiAtlasFlagMixin implements MultiAtlasMarked, BlockModelWrapperMultiAtlasFlagAccessor {
    @Unique private boolean obsidian$multiAtlas;
