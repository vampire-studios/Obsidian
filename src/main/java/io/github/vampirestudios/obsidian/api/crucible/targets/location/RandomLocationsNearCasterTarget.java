...
public class RandomLocationsNearCasterTarget extends LocationTarget {
    ...
    public RandomLocationsNearCasterTarget(int amount, double radius, double minRadius, double spacing, boolean onSurface) {
        super(List.of("RandomLocationsNearCaster", "randomLocations", "RLNC"));
        this.amount = amount;
        this.radius = radius;
    ...
    public List<Vec3> getTargets(LivingEntity caster) {
        ...
        for (int i = 0; i < amount; i++) {
            ...
            do {
                randomLocation = getRandomLocationNearCaster(casterPosition);
                attempts++;
    ...
    private Vec3 getRandomLocationNearCaster(Vec3 casterPosition) {
        ...
        return casterPosition.add(offsetX, 0, offsetZ);
    }
