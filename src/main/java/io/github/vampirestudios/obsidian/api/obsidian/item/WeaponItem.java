...
public class WeaponItem extends Item {
	...
	public enum WeaponType {
		...
		@SerializedName("spear") SPEAR,
		@SerializedName("mace") MACE,
		@SerializedName("longsword") LONGSWORD,
		@SerializedName("rapier") RAPIER,
		@SerializedName("dagger") DAGGER,
		@SerializedName("knife") KNIFE,
		@SerializedName("cleaver") CLEAVER,
		@SerializedName("scythe") SCYTHE
	}
	...
	@SerializedName("backstab_multiplier")
	...
	public ToolMaterial getTier() {
		switch (material) {
			...
			case null, default ->
					throw new IllegalStateException("Material field is null or unrecognized type for: " + this.information.id);
		}
	}
