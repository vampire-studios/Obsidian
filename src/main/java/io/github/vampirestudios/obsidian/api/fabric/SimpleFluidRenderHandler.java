 ...
 * that.
 */
public class SimpleFluidRenderHandler implements ExpandedFluidRenderHandler {
	 ...
	 * {@linkplain ExpandedFluidRenderHandlerRegistry#setBlockTransparency registered
	 * transparent blocks}.
	 */
