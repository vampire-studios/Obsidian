...
public class GuiUtils
{
    ...
    public static void drawHoveringText(MatrixStack mStack, List<? extends StringRenderable> textLines, int mouseX, int mouseY, int screenWidth, int screenHeight, int maxTextWidth, TextRenderer font) {
    ...
    public static void drawHoveringText(final ItemStack stack, MatrixStack mStack, List<? extends StringRenderable> textLines, int mouseX, int mouseY, int screenWidth, int screenHeight, int maxTextWidth, TextRenderer font)
    {
    ...
    public static void drawHoveringText(final ItemStack stack, MatrixStack mStack, List<? extends StringRenderable> textLines, int mouseX, int mouseY, int screenWidth, int screenHeight,
        ...
        if (!textLines.isEmpty()) {
            TooltipRenderer.Pre pre = new TooltipRenderer.Pre(stack, textLines, mStack, mouseX, mouseY, screenWidth, screenHeight, maxTextWidth, font);
            RenderTooltipCallback.PreNewNew.EVENT.invoker().preRender(pre);
            mouseX = pre.getX();
            mouseY = pre.getY();
            ...
            if (needsWrap)
            {
                ...
                List<StringRenderable> wrappedTextLines = new ArrayList<>();
            ...
            TooltipRenderer.Color colorEvent = RenderTooltipCallback.Color.EVENT.invoker().color(stack, textLines, mStack, tooltipX, tooltipY, font, backgroundColor, borderColorStart, borderColorEnd);
            ...
            TooltipRenderer.PostBackground postBackground = new TooltipRenderer.PostBackground(stack, textLines, mStack, tooltipX, tooltipY, font, tooltipTextWidth, tooltipHeight);
            ...
            TooltipRenderer.PostText postText = new TooltipRenderer.PostText(stack, textLines, mStack, tooltipX, tooltipTop, font, tooltipTextWidth, tooltipHeight);
