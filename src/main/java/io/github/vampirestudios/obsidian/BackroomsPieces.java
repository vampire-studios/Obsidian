...
public class BackroomsPieces {
    static class BackroomsRoom extends StructurePiece {
        ...
        @Override
        public void addChildren(StructurePiece start, StructurePieceAccessor pieces, RandomSource random) {
    ...
    static StructurePiece generateAndAddPiece(StructurePiece start, StructurePieceAccessor pieces, RandomSource random, int x, int y, int z, Direction orientation, int depth, BackroomsLevel level) {
