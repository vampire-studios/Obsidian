...
public class MusicDiscs implements AddonModule {
    ...
    public void init(IAddonPack addon, File file, BasicAddonInfo id) throws IOException, SyntaxError {
        ...
        try {
            ...
            if (musicDisc.information.name.id == null) musicDisc.information.name.id = new Identifier(id.modId(), file.getName().replaceAll(".json", ""));

            Registry.register(Registry.ITEM, identifier, new MusicDiscItemImpl(musicDisc, settings
