...
public class ContentUtils {
	...
	public static WoodType getWoodType(Identifier id) {
	...
	public static SoundType getSoundType(Identifier id) {
	...
	public static SoundEvent getSoundEvent(Identifier sound) {
