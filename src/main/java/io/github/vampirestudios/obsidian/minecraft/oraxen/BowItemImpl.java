...
public class BowItemImpl extends BowItem {
	...
	public BowItemImpl(NexoItem item, Properties settings) {
		super(settings);
		this.item = item;
	}
...
//	}
	...
	public int getDefaultProjectileRange() {
		return (item.mechanics != null && item.mechanics.bow != null) ? item.mechanics.bow.range : super.getDefaultProjectileRange();
	}
}