...
public class ObsidianBundleMouseActions implements ItemSlotMouseAction {
	private final Minecraft minecraft;
	private final ScrollWheelHandler scrollWheelHandler;

	public ObsidianBundleMouseActions(Minecraft minecraft) {
	...
	public boolean matches(Slot slot) {
		return slot.getItem().getItem() instanceof BundleItem;
	}
