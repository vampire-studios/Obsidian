...
public class Utils {
	...
	public static void registerAddon(File legacyInfoFile, File newInfoFile, Optional<File> fabricModJson) throws IOException {
		if (legacyInfoFile.exists()) {
			LegacyObsidianAddonInfo obsidianAddonInfo = AddonFormats.read(legacyInfoFile, LegacyObsidianAddonInfo.class);
		...
		if (newInfoFile.exists()) {
			ObsidianAddonInfo obsidianAddonInfo = AddonFormats.read(newInfoFile, ObsidianAddonInfo.class);
