    ...
    private static com.mojang.brigadier.builder.RequiredArgumentBuilder<CommandSourceStack, ?> attachArguments(
        ...
        for (CommandArgumentDef def : args) {
            var arg = switch (def.type) {
                ...
                case "integer" -> Commands.argument(def.name, com.mojang.brigadier.arguments.IntegerArgumentType.integer());
                case "string" -> Commands.argument(def.name, com.mojang.brigadier.arguments.StringArgumentType.string());
