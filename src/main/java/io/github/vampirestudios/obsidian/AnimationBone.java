...
public class AnimationBone {
    ...
    public Map<Double, Vec3f> rotationData, translationData, scaleData;
    ...
    public Vec3f getDataForFrame(double timestamp, Transformation type) {
        switch(type) {
            case ROTATION:
    ...
    public void setRotation(Map<Double, Vec3f> data) {
        this.hasRotation = true;
        this.rotationData = data;
    }

    public void setTranslation(Map<Double, Vec3f> data) {
        this.hasTranslation = true;
        this.translationData = data;
    }

    public void setScale(Map<Double, Vec3f> data) {
        this.hasScale = true;
        this.scaleData = data;
    }
    ...
    public static class Deserializer implements JsonDeserializer<AnimationBone> {
        ...
        public AnimationBone deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            if(obj.has("rotation")) {
                Map<Double, Vec3f> data = new HashMap<>();
                obj.get("rotation").getAsJsonObject().entrySet().forEach(e -> {
                    ...
                    data.put(timestamp, new Vec3f(array.get(0).getAsFloat(), array.get(1).getAsFloat(), array.get(2).getAsFloat()));
                });
