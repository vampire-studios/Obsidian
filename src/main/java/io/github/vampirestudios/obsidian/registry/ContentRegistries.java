...
public class ContentRegistries {
	...
	public static Registry<Block> BLOCK_TEMPLATES = FabricRegistryBuilder.create(Block.class, id("block_templates")).buildAndRegister();
	public static Registry<io.github.vampirestudios.obsidian.api.obsidian.projectile.Projectile> PROJECTILES = FabricRegistryBuilder.create(io.github.vampirestudios.obsidian.api.obsidian.projectile.Projectile.class, id("projectiles")).buildAndRegister();
	public static Registry<io.github.vampirestudios.obsidian.api.obsidian.world.Portal> PORTALS = FabricRegistryBuilder.create(io.github.vampirestudios.obsidian.api.obsidian.world.Portal.class, id("portals")).buildAndRegister();
	public static Registry<io.github.vampirestudios.obsidian.api.obsidian.world.Pattern> PATTERNS = FabricRegistryBuilder.create(io.github.vampirestudios.obsidian.api.obsidian.world.Pattern.class, id("patterns")).buildAndRegister();
	public static Registry<io.github.vampirestudios.obsidian.api.obsidian.world.WorldEvent> WORLD_EVENTS = FabricRegistryBuilder.create(io.github.vampirestudios.obsidian.api.obsidian.world.WorldEvent.class, id("world_events")).buildAndRegister();
...
//	public static Registry<KeyBinding> KEY_BINDINGS = FabricRegistryBuilder.create(KeyBinding.class, id("key_bindings")).buildAndRegister();
	...
	public static Registry<BrewingFuelSource> BREWING_FUEL_SOURCES = FabricRegistryBuilder.create(BrewingFuelSource.class, id("brewing_fuel_sources")).buildAndRegister();
	...
	public static Registry<Palette> PALETTES = FabricRegistryBuilder.create(Palette.class, id("palettes")).buildAndRegister();
