...
public record Wearable(boolean dispensable, EquipmentSlotGroup slot, boolean hasOverlay, Identifier overlayTexture) {
	public static final Codec<Wearable> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			Identifier.CODEC.fieldOf("overlay_texture").forGetter(Wearable::overlayTexture)
