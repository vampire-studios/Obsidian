...
public final class V1ModMetadata extends AbstractModMetadata implements LoaderModMetadata {
    public static final IconEntry NO_ICON = size -> Optional.empty();
    ...
    public V1ModMetadata(String id, Version version, Collection<String> provides,
        ...
        this.contact = Objects.requireNonNullElse(contact, ContactInformation.EMPTY);

        this.license = Collections.unmodifiableCollection(license);

        this.icon = Objects.requireNonNullElse(icon, V1ModMetadata.NO_ICON);
