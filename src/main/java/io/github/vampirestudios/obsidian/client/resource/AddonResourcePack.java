...
public class AddonResourcePack implements ResourcePack {
	...
	public AddonResourcePack() {
		virtualPacks = ConfigHelper.ADDON_PACKS.stream().map(IAddonPack::getVirtualResourcePack).filter(Objects::nonNull).toArray(ResourcePack[]::new);
	}
